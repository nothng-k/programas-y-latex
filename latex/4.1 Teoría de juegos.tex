...
\usepackage{biblatex}%Para poner referencias
...
Vamos a exponer una froma de representación simple, compacta e intuitiva, éste método de representación que se suele usar en redes bayesianas fué introducido para teoría de jugos por howard en(Howard and netherson)% añadir referencia % 
...
%añadir ejemplo 3.4 del libro de joaquin%
